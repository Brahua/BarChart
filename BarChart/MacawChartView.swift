...
class MacawChartView: MacawView {
    ...
    private static func createChart() -> Group {
        var items: [Node] = addYAxisItems() + addYAxisItems()
    ...
    private static func createDummyData() -> [Budget] {
        let one = Budget(month: "Enero", budget: 3200)
        let two = Budget(month: "Enero", budget: 4200)
        let three = Budget(month: "Enero", budget: 5200)
        let four = Budget(month: "Enero", budget: 3800)
        let five = Budget(month: "Enero", budget: 3990)
